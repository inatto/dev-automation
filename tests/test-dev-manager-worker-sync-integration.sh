...
grep -q 'ensure_worker_sync' "$ROOT/scripts/dev-manager/dev-manager.sh"
grep -q 'DEV_MANAGER_WORKER_ENSURE' "$ROOT/scripts/dev-manager/dev-manager.sh"
grep -q 'apps/worker-sync/deploy/local/ensure.sh' "$ROOT/scripts/dev-manager/dev-manager.sh"
...
grep -q 'WORKER TO:' "$ROOT/scripts/dev-manager/dev-manager-tui.py"
grep -q 'WORKER FROM:' "$ROOT/scripts/dev-manager/dev-manager-tui.py"
grep -q 'ZIPs FROM:' "$ROOT/scripts/dev-manager/dev-manager-tui.py"
...
grep -A3 -F 'commands|refresh-commands|install-commands)' "$ROOT/scripts/dev-manager/dev-manager.sh" | grep -q 'ensure_worker_sync'
