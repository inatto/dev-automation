...
CLEAR_TERMINAL="$PROJECT_ROOT/scripts/core/clear-terminal.sh"
AUTO_MANAGER="${DEV_AUTOMATION_AUTO_MANAGER:-$PROJECT_ROOT/scripts/dev-manager/auto-code-manager.sh}"
