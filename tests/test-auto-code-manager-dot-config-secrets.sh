...
ENV
run(){ HOME="$H" DOWNLOADS_DIR="$D" CODE_ROOT="$C" DEV_MANAGER_PROJECTS_FILE="$M/config/projects/default.projects" AUTO_CODE_STATE_DIR="$S" AUTO_CODE_TUI=off "$M/scripts/dev-manager/auto-code-manager.sh" "$@"; }
