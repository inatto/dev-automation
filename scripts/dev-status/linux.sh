...
Uso:
  ...
  dev-status download_done [detalhe]
  dev-status file_inserted [detalhe]
  dev-status file_changed [detalhe]
  dev-status file_removed [detalhe]
  dev-status ddl_zip [detalhe]
  dev-status warning [detalhe]
